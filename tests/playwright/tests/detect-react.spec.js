...
// Note: served at `/` — this worktree's history already ran the playground.html → React
// cutover (see src/api/web_assets.rs), so there is no separate `/preview` route to target.
// Matches the precedent set by dashboard-react.spec.js.
