...
// Skipped: the TTS panel isn't in the new React frontend yet — the legacy
// playground.html this suite targeted was retired at cutover. Re-enable
// (rebuilt against the React DOM) when that panel is migrated.
test.describe.skip('TTS Stream', () => {
